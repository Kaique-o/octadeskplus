...
export function errorMessage(e: unknown): string {
  ...
  const map: Record<string, string> = {
    ...
    ultimo_master: 'A empresa precisa de pelo menos um Master ativo. Promova outra pessoa a Master antes.',
    perfil_fixo: 'O perfil Master é fixo: não pode ser editado nem excluído.',
    master_obrigatorio: 'Informe o e-mail do usuário Master da empresa.',
